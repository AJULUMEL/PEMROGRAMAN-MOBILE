...
class TakePictureScreenState extends State<TakePictureScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(title: const Text('Dandi Azrul Syahputra - 2341720118')),
      ...
      body: FutureBuilder<void>(
        ...
        builder: (context, snapshot) {
          if (snapshot.connectionState == ConnectionState.done) {
            // If the Future is complete, display the preview with filter overlay.
            return Stack(
              children: [
                Positioned.fill(
                  child: ColorFiltered(
